...
class PollOptionService:
    ...
    def create(key: str, value: str, poll_id: str) -> PollOptionDto:
        ...
        return PollOptionDto(key=new_option.key, value=new_option.value)
    ...
    def get_by_poll_id(poll_id: str) -> List[PollOptionDto]:
        ...
        return  [PollOptionDto(key = poll_option.key, value=poll_option.value )for  poll_option in poll_options]